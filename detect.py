...
net = cv2.dnn.readNetFromCaffe('C:/Users/Akash/PycharmProjects/ssd/MobileNetSSD_deploy.prototxt.prototxt',
...
# initialize dictionary to store count of each class
...
while ret:
    ...
    cv2.putText(frame, label, (startX, y), cv2.FONT_HERSHEY_DUPLEX, 0.5,
                COLORS[idx], 1)
